...
//     {
//         id:"0",
// image:"https://manjulaskitchen.com/wp-content/uploads/chilli_paneer.jpg"  ,      name:"Meghana Foods",
//         rating:4.4,
//         time:"30-40",
...
//                         rating:4.1,
//                         ratings:43,
// image:"https://manjulaskitchen.com/wp-content/uploads/chilli_paneer.jpg",                    veg:true,
//                         bestSeller:false,
//                         quantity:1,
//                     },
//                     {
...
//                         rating:4.3,
//                         ratings:34,
// image:"https://manjulaskitchen.com/wp-content/uploads/chilli_paneer.jpg",                        veg:false,
//                         bestSeller:true,
//                         quantity:1,
//                     },
//                     {
...
//                         rating:3.8,
//                         ratings:22,
// image:"https://manjulaskitchen.com/wp-content/uploads/chilli_paneer.jpg",                        bestSeller:true,
//                         quantity:1,
//                     },
//                     {
//                         id:"105",
...
//                         rating:4.5,
//                         ratings:45,
//                         image:"https://manjulaskitchen.com/wp-content/uploads/chilli_paneer.jpg",        name:"Behrouz Biriyani",
//                         veg:false,
//                         bestSeller:true,
//                         quantity:1,
//                     }
...
const hotelData = [
    {
      id: "0",
      image: "https://manjulaskitchen.com/wp-content/uploads/chilli_paneer.jpg",
      name: "Meghana Foods",
      rating: 4.4,
      time: "30-40",
      adress: "Residency Road, Ashok Nagar",
    ...
    ...Array.from({length: 15}, (_, i) => ({
      ...
      time: `${Math.floor(Math.random() * 20) + 30}-${Math.floor(Math.random() * 20) + 40}`,
      adress: `Address ${i + 1}, City Center`,
      ratings: `${Math.floor(Math.random() * 1000) + 100}`,
      cost_for_two: Math.floor(Math.random() * 300) + 200,
      cuisines: i % 5 === 0 ? 'Chinese' : 'Indian'
    }))
  ];
